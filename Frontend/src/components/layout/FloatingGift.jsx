  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[305px] sm:bottom-[235px] right-0 bg-[#F8B400] text-white p-3 pl-4 rounded-l-xl shadow-2xl hover:bg-[#F8B400]/90 transition-all duration-300 z-50 flex items-center justify-center group"
      >
